...
class DebtorAccount(object):
    ...
    def name(self):
        ...
        Name of the account, as assigned by the account servicing institution, in agreement with the account owner in order to provide an additional means of identification of the account. Usage: The account name is different from the account owner name. The account name is used in certain user communities to provide a means of identifying the account, in addition to the account owner's identity and the account number.  # noqa: E501
    ...
    def secondary_identification(self):
        """Gets the secondary_identification of this DebtorAccount.  # noqa: E501
        ...
        :return: The secondary_identification of this DebtorAccount.  # noqa: E501
        :rtype: str
        """
    ...
    def secondary_identification(self, secondary_identification):
        """Sets the secondary_identification of this DebtorAccount.

        This is secondary identification of the account, as assigned by the account servicing institution. This can be used by building societies to additionally identify accounts with a roll number (in addition to a sort code and account number combination).  # noqa: E501

        :param secondary_identification: The secondary_identification of this DebtorAccount.  # noqa: E501
        :type: str
        """
